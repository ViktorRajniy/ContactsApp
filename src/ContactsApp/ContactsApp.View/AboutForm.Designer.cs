namespace ContactsApp.View
{
	partial class AboutForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label6.Text = "All used images are download from";
			// 
			// linkLabel1
			// 
			this.linkLabel1.AutoSize = true;
			this.linkLabel1.Location = new System.Drawing.Point(221, 305);
			...
			this.label8.Text = "rajniyviktor@yandex.ru";
			// 
			// label9
			// 
			...
			this.label9.Text = "Viktor Oxingert";
			// 
			// linkLabel2
			// 
			this.linkLabel2.AutoSize = true;
			this.linkLabel2.Location = new System.Drawing.Point(84, 126);
			this.linkLabel2.Name = "linkLabel2";
			this.linkLabel2.Size = new System.Drawing.Size(156, 13);
			this.linkLabel2.TabIndex = 10;
			this.linkLabel2.TabStop = true;
			this.linkLabel2.Text = "https://github.com/ViktorRajniy";
